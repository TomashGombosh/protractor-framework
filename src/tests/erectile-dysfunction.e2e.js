...
import ErectileDysfunctionComponent from '../page_objects/components/ErectileDysfucntionComponent';
...
describe('Erectile-DysfunctionPage', () => {
    ...
    const erectiledysfunctioncomponent = new ErectileDysfunctionComponent();
    ...
    beforeEach(() => {
        ...
        expect(isDisplayed(erectileDysfunctionPage.sildenafilContent.sildenafil)).
        toBe(true);
        expect(isDisplayed(erectileDysfunctionPage.sildenafilContent.sildenafilDescription)).
        toBe(true);
        expect(isDisplayed(erectileDysfunctionPage.sildenafilContent.sildenafilStartFromButtonText)).
        toBe(true);
        
        expect(isDisplayed(erectileDysfunctionPage.tadalafilContent.tadalafil)).
        toBe(true);
        expect(isDisplayed(erectileDysfunctionPage.tadalafilContent.tadalafilDescription)).
        toBe(true);
        expect(isDisplayed(erectileDysfunctionPage.tadalafilContent.tadalafilStartFromButton)).
        toBe(true);
        
        expect(isDisplayed(erectileDysfunctionPage.viagraConnectContent.viagraConnect)).toBe(true);
        expect(isDisplayed(erectileDysfunctionPage.viagraConnectContent.viagraConnectDescription)).
        toBe(true);
        expect(isDisplayed(erectileDysfunctionPage.viagraConnectContent.viagraConnectStartFromButton)).
        toBe(true);
        ...
        expect(getText(erectileDysfunctionPage.sildenafilContent.sildenafilDescription)).
        toEqual(erectiledysfunction.sildenafil.shortDescriptionSildenafil);
        expect(getText(erectileDysfunctionPage.tadalafilContent.tadalafilDescription)).
        toEqual(erectiledysfunction.tadalafil.shortDescriptionTadalafil);
        expect(getText(erectileDysfunctionPage.viagraConnectContent.viagraConnectDescription)).
        toEqual(erectiledysfunction.viagraConnect.shortDescriptionViagraConnect);
        expect(getText(erectileDysfunctionPage.viagraContent.viagraDescription)).
        toEqual(erectiledysfunction.viagra.shortDescriptionViagra);
    ...
    it('Added new goods to the cart', () => {
        ...
        expect(getText(viagraSildenafilPage.title.itemHasreplacedText)).
        toEqual(erectiledysfunction.replacedText.itemHasReplaced)
    ...
    it('How to use Sildenafil', () => {
        ...
        expect(isDisplayed(erectiledysfunctioncomponent.content.getInTheMoodImg));
        expect(isDisplayed(erectiledysfunctioncomponent.content.getInTheMoodDescription))
        expect(getText(erectiledysfunctioncomponent.content.getInTheMoodDescription)).
        toEqual(erectiledysfunction.getInTheMood.getInTheMoodDescription)
       
        expect(isDisplayed(erectiledysfunctioncomponent.content.takeThePillImg));
        expect(isDisplayed(erectiledysfunctioncomponent.content.takeThePillDescription));
        expect(getText(erectiledysfunctioncomponent.content.takeThePillDescription)).
        toEqual(erectiledysfunction.pill.pillDescription);
        
        expect(isDisplayed(erectiledysfunctioncomponent.content.enjoyImg));
        expect(isDisplayed(erectiledysfunctioncomponent.content.enjoyDescription));
        expect(getText(erectiledysfunctioncomponent.content.enjoyDescription)).
        toEqual(erectiledysfunction.enjoy.enjoyDescription);
        ...
        expect(getText(viagraSildenafilPage.title.frequentlyDescriptionSecond)).
        toEqual(erectiledysfunction.second.secondDescription);
        ...
        expect(getText(viagraSildenafilPage.title.frequentlyDescriptionThird)).
        toEqual(erectiledysfunction.third.thirdDescription)
        ...
        expect(getText(viagraSildenafilPage.title.frequentlyDescriptionfour)).
        toEqual(erectiledysfunction.four.fourDescription);
